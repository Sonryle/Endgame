...
const netherite_helmet = new Item("./src/assets/textures/item/netherite_helmet.png", ItemType.HELMET, 2, 3, null, "Netherite Helmet");
const netherite_chestplate = new Item("./src/assets/textures/item/netherite_chestplate.png", ItemType.CHESTPLATE, 2, 8, ["Protection IV", "Thorns III", "Mending"], "Netherite Chestplate");
const netherite_leggings = new Item("./src/assets/textures/item/netherite_leggings.png", ItemType.LEGGINGS, 2, 6, null, "Netherite Leggings");
const netherite_boots = new Item("./src/assets/textures/item/netherite_boots.png", ItemType.BOOTS, 2, 3, null, "Netherite Boots");
...
const iron_chestplate = new Item("./src/assets/textures/item/iron_chestplate.png", ItemType.CHESTPLATE, 2, 8, ["Bench V 60kg", "Bench IX 50kg", "Bench VIII 50kg", "Pike Push V 0.9m", "Pike Push VIII 1.1m", "Pike Push VII 1.1m", "Dip IV 27kg", "Dip VIII 20kg", "Dip VII 20kg"], "Iron Chestplate");
