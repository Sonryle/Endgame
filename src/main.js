...
const enchanted_diamond_helmet = new ItemInstance( MinecraftItem.diamond_helmet, ["Good Looks XII"], null);
...
items[26] = book;
items[35] = carrot;
items[44] = enchanted_diamond_helmet;
items[5] = diamond_helmet;
items[6] = diamond_chestplate;
